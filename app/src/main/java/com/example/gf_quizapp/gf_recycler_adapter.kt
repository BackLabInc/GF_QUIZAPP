...
class gf_recycler_adapter : RecyclerView.Adapter<gf_recycler_adapter.ViewHolder>() {
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(superhero:gf_question, context: Context){
    ...
    fun RecyclerAdapter(superheros : MutableList<gf_question>, context: Context){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        return ViewHolder(layoutInflater.inflate(R.layout.gf_question_item_app, parent, false))
    }
